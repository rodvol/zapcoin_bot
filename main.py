...
from dca_handlers import handle_dca, handle_dca_ca, handle_dca_amount, handle_dca_frequency, handle_cancel_dca
...
from wallet_handlers import handle_wallet, handle_create_wallet, handle_import_wallet, handle_check_balance, handle_transaction_history, handle_select_wallet, handle_toggle_wallet, handle_deposit_sol, handle_withdraw_all_sol, handle_withdraw_x_sol, handle_reset_wallet, handle_export_private_key, handle_refresh_wallet
...
from navigation_handlers import ( handle_back, handle_start, handle_buy, handle_refresh, handle_sell_manage, handle_help, handle_pin, handle_token_input, snipe_token, handle_snipe,
                                 handle_trade_token, handle_token_detail, process_sell, process_buy, handle_sell, execute_limit_buy, execute_limit_sell, handle_limit_buy, handle_limit_sell, handle_trade_action)
...
def main():
    ...
    application.add_handler(CallbackQueryHandler(handle_create_wallet, pattern='create_wallet'))
    ...
    application.add_handler(CallbackQueryHandler(handle_transaction_history, pattern='transaction_history'))
    application.add_handler(CallbackQueryHandler(handle_select_wallet, pattern='select_wallet'))
    application.add_handler(CallbackQueryHandler(handle_toggle_wallet, pattern=r'toggle_'))
    application.add_handler(CallbackQueryHandler(handle_deposit_sol, pattern='deposit_sol'))
    application.add_handler(CallbackQueryHandler(handle_withdraw_all_sol, pattern='withdraw_all_sol'))
    application.add_handler(CallbackQueryHandler(handle_withdraw_x_sol, pattern='withdraw_x_sol'))
    application.add_handler(CallbackQueryHandler(handle_reset_wallet, pattern='reset_wallet'))
    ...
    application.add_handler(CallbackQueryHandler(handle_sell_manage, pattern='sell_manage'))
